...
def modelSetup(classes):
    ...
    model = timm.create_model('vit_small_patch16_gap_224', img_size=448, patch_size=32, pretrained=False, num_classes=len(classes), drop_path_rate = 0.1, drop_rate=0.05)
