...
FLAGS['modelDir'] = FLAGS['rootPath'] + 'models/levit-256-1588-ASL-Balanced-PerClass-dual/'
...
def trainCycle(image_datasets, model):
    ...
    criterion = MLCSL.AsymmetricLossAdaptive(gamma_neg=1, gamma_pos=0, clip=0.05, eps=1e-8, disable_torch_grad_focal_loss=True, adaptive = True, gap_target = 0.1, gamma_step = 0.05)
