...
if currGPU == '3090':
    ...
    FLAGS['modelDir'] = FLAGS['rootPath'] + 'models/regnety_040-ASL_BCE_-_T-224-1588/'
...
def modelSetup(classes):
    ...
    model = timm.create_model('regnety_040', pretrained=False, num_classes=len(classes), drop_path_rate=0.15)
