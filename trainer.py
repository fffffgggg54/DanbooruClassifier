...
FLAGS['modelDir'] = FLAGS['rootPath'] + 'models/tf_efficientnetv2_b1-1588-Hill/'
...
def modelSetup(classes):
    ...
    model = timm.create_model('tf_efficientnetv2_b1', pretrained=True, num_classes=len(classes))
