            ...
            for i, (images, tags) in loaderIterable:
                ...
                if i % stepsPerPrintout == 0:
                    ...
                    if is_head_proc:
                        ...
                        t_p_values = scipy.stats.ttest_ind_from_stats(dist_tracker.pos_mean.numpy(), dist_tracker.pos_std.numpy(), dist_tracker.pos_count.numpy(), dist_tracker.neg_mean.numpy(), dist_tracker.neg_std.numpy(), dist_tracker.neg_count.numpy(), equal_var=False, alternative="greater")
