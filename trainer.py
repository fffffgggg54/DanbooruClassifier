...
if currGPU == '3090':
    ...
    FLAGS['modelDir'] = "/media/fredo/Storage3/danbooru_models/davit_tiny-NormPL_D090_L065_ModUpdate_HardMod-ASL_BCE_T-dist-x+10e-1-224-1588-50epoch/"
            ...
            for i, (images, tags) in loaderIterable:
                ...
                if i % stepsPerPrintout == 0:
                    ...
                    if is_head_proc:
                        ...
                        bins=100
                        plotext.hist(dist_tracker.neg_mean.detach().where(dist_tracker.neg_mean.detach() < -6, -6), bins, label='Neg means')
