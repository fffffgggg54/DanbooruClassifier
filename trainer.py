...
if currGPU == '3090':
    ...
    FLAGS['modelDir'] = FLAGS['rootPath'] + 'models/vit_base_patch32_clip_224-ft-Hill-T-1588/'
...
def trainCycle(image_datasets, model):
    ...
    boundaryCalculator = MLCSL.getDecisionBoundary(initial_threshold = 0.5, lr = 1e-5, threshold_min = 0.01, threshold_max = 0.99)
    if (FLAGS['resume_epoch'] > 0):
