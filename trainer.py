...
FLAGS['modelDir'] = FLAGS['rootPath'] + 'models/vit_base_patch8_224-1588-SPLC/'
...
def modelSetup(classes):
    ...
    model = timm.create_model('vit_base_patch8_224.augreg_in21k', pretrained=True, num_classes=len(classes))
