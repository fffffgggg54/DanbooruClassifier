...
if currGPU == '3090':
    ...
    FLAGS['modelDir'] = "/media/fredo/Storage3/danbooru_models/regnetx_008-Hill-T-F1-x+00e-1-224-1588-20epoch/"
...
def modelSetup(classes):
    ...
    model = timm.create_model('regnetx_008', pretrained=False, num_classes=len(classes), drop_path_rate = 0.1)
