...
def trainCycle(image_datasets, model):
    ...
    criterion = MLCSL.AsymmetricLossAdaptiveWorking(gamma_neg=1, gamma_pos=1, clip=0.0, eps=1e-8, disable_torch_grad_focal_loss=False, adaptive = True, gap_target = 0.1, gamma_step = 0.003)
