...
def modelSetup(classes):
    ...
    model = timm.create_model('vit_base_patch16_gap_224', pretrained=Fasle, num_classes=len(classes), drop_path_rate=0.4, patch_size=32, img_size=img_size = FLAGS['actual_image_size'])
