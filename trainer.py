...
FLAGS['modelDir'] = FLAGS['rootPath'] + 'models/tf_efficientnetv2_b0-ASL-BCE/'
...
def modelSetup(classes):
    ...
    model = timm.create_model('tf_efficientnetv2_b0', pretrained=False, num_classes=len(classes), drop_path_rate = 0.1)
