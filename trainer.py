...
if currGPU == '3090':
    ...
    FLAGS['modelDir'] = FLAGS['rootPath'] + 'models/tresnet_xl-448-ASL_BCE_T-1588_v100/'
...
def modelSetup(classes):
    ...
    model = timm.create_model('tresnet_xl', pretrained=False, num_classes=len(classes), drop_path_rate=0.4)
