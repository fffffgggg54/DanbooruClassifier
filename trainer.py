...
if currGPU == '3090':
    ...
    FLAGS['modelDir'] = "/media/fredo/Storage3/danbooru_models/davit_tiny-MLP_StarAct_PyrH-MLR_NW-ASL_BCE-224-1588-50epoch/"
...
def modelSetup(classes):
    ...
    model = PyramidFeatureAggregationModel(model, len(classes), head_type='mlp', head_act=StarAct)
    '''
