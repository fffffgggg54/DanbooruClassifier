...
if currGPU == '3090':
    ...
    FLAGS['modelDir'] = FLAGS['rootPath'] + 'models/davit_base-ASL_BCE_T-5500/'
...
def modelSetup(classes):
    ...
    #model = timm.create_model('gernet_m', pretrained=False, num_classes=len(classes), drop_path_rate = 0.)
