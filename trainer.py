...
if currGPU == '3090':
    ...
    FLAGS['modelDir'] = "/media/fredo/Storage3/danbooru_models/davit_tiny-MLRHead_ExplicitTrain_NoBias-ASL_BCE-224-1588-50epoch/"
...
def modelSetup(classes):
    ...
    if FLAGS['use_mlr_act'] == True:
        ...
        mlr_head = MLCSL.ModifiedLogisticRegression_Head(num_features, num_classes = len(classes), bias=False, initial_beta = 1.0, eps = 1e-8)
