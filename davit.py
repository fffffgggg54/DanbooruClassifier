...
import timm
from timm.models.layers import DropPath, to_2tuple, trunc_normal_, SelectAdaptivePool2d
...
class DaViT(nn.Module):
    ...
    def __init__(self, in_chans=3, depths=(1, 1, 3, 1), patch_size=4,
                 ...
                 drop_rate=0., attn_drop_rate=0., img_size=224, num_classes=101
                 ):
        super().__init__()
        ...
        self.head = nn.Sequential(OrderedDict([
            ...
            ('norm', norm_layer([num_features,1,1])),
            ('flatten', nn.Flatten(1)),
            ('drop', nn.Dropout(drop_rate)),
            ('fc', nn.Linear(num_features, num_classes) if num_classes > 0 else nn.Identity())]))
